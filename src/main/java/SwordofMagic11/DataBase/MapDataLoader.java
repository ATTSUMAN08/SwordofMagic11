            ...
            try {
                ...
                if (data.isSet("Npc")) {
                    for (String npc : data.getStringList("Npc")) {
                        ...
                        npcData.setType(Registry.VILLAGER_TYPE.getOrThrow(NamespacedKey.minecraft(data.getString(npc + ".Type", "PLAINS").toLowerCase(Locale.ROOT))));
                        npcData.setProfession(Registry.VILLAGER_PROFESSION.getOrThrow(NamespacedKey.minecraft(data.getString(npc + ".Profession", "ARMORER").toLowerCase(Locale.ROOT))));
